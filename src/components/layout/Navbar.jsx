        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <Link to="/" className="flex-shrink-0 flex items-center gap-2 group">
              ...
              <span className="font-bold text-xl text-gray-900 tracking-tight block">
                Connect
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            {token ? (
              ...
              <>
                ...
                <Link 
                  to="/register" 
                  className="bg-blue-50 text-blue-700 hover:bg-blue-100 px-3 py-2 rounded-md text-sm font-medium transition-colors block"
                >
                  Đăng ký
                </Link>
                <Link 
