                  ...
                  {profileLoading ? (
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-4">
                        <img 
                          src={profile.user?.avatar || 'https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y'} 
                          alt={profile.user?.name} 
                          className="w-11.5 h-11.5 rounded-full object-cover border border-gray-200"
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-2xs text-gray-500 flex items-center gap-1 mt-0.5 truncate">
                      ...
                      <div className="flex items-center justify-between p-3.5 bg-indigo-50/50 rounded-xl border border-indigo-50/60 mb-4">
                        <div className="flex items-center gap-2">
                          <Star className="w-5 h-5 text-yellow-500 fill-yellow-500" />
                          <div>
                            <p className="text-3xs text-gray-400 font-bold uppercase tracking-wider">Điểm uy tín</p>
                            <p className="text-sm font-extrabold text-indigo-700">{profile.user?.reputation || 0} điểm</p>
                          </div>
                        </div>
                        <span className="text-3xs px-2 py-0.5 bg-indigo-100 text-indigo-700 font-bold rounded-full">
                          Thành viên
                        </span>
                      </div>
                      ...
                      <a 
                        ...
                        className="flex items-center justify-between text-xs font-semibold text-blue-600 hover:text-blue-700 hover:bg-blue-50/80 p-2 rounded-lg transition-colors"
                      >
                    ...
                    <div className="text-center py-4">
                      <p className="text-xs text-gray-500">Chưa thiết lập hồ sơ cá nhân</p>
                      <a href="/edit-profile" className="mt-2 inline-block text-xs font-semibold text-blue-600 hover:underline">Tạo hồ sơ ngay</a>
                    </div>
                  )}
                </div>
              )}
